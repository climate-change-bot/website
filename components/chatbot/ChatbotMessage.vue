        ...
        <div class="flex flex-col space-y-2 text-base mx-2 order-1 items-end chat-message-container">
          <div>
            ...
            <div v-else-if="!isLoading && isOpenAi"
              ...
              <dropdown>
                <div class="flex flex-row-reverse mt-2 items-center chatbot-message-info">
                  ...
                  <div class="mr-1.5 text-xs"><span class="inline-block text-center">Open AI</span></div>
                </div>
                <template #popper>
                  Diese Antwort wurde von einer KI (OpenAI) generiert. Es kann deshalb vorkommen, dass die Angaben
